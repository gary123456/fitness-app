...
export default function RootLayout({
  ...
  return (
    <html lang="fr" suppressHydrationWarning>
      {/* On ajoute pb-20 md:pb-0 pour que la barre mobile ne cache pas le footer */}
      <body className="min-h-screen flex flex-col antialiased bg-zinc-50 dark:bg-zinc-950 pb-20 md:pb-0">
        
        {/* LA NOUVELLE NAVBAR (Remplace l'ancien header statique) */}
        <Navbar />
