...
import { Trophy, Flame, Award, Star, Target, Zap, Loader2, Brain, BookOpen, GraduationCap, Camera, ChevronRight, Lock, CheckCircle2 } from "lucide-react";
...
export default function ProfilePage() {
  ...
  // 🛡️ CORRECTION : Vérifie si l'avatar est une vraie URL (http) ou juste un émoji
  ...
  return (
    <div className="flex-1 space-y-8 p-4 md:p-8 pt-6 max-w-5xl mx-auto w-full pb-24">
      ...
      <Dialog open={showXpModal} onOpenChange={setShowXpModal}>
        <DialogContent className="sm:max-w-[400px] bg-zinc-950 border-zinc-800 rounded-3xl">
          <DialogHeader className="text-center pb-4">
            <DialogTitle className="text-xl font-black text-teal-400">Expérience & Progression</DialogTitle>
          </DialogHeader>
          <div className="flex flex-col items-center space-y-6">
            <div className="relative w-40 h-40 flex items-center justify-center">
              ...
              <div className="absolute flex flex-col items-center">
                ...
                <span className="text-[10px] font-bold text-teal-500 uppercase tracking-widest">Niveau</span>
              </div>
            </div>
            <div className="text-center w-full">
              <p className="text-sm font-bold text-zinc-300 mb-1">{data.current_xp} / {nextLevelXP} XP</p>
              <p className="text-xs text-zinc-500">Gagnez de l'XP en soulevant lourd et en répondant aux quiz quotidiens.</p>
            </div>
          </div>
          <DialogFooter className="mt-4">
            <Button onClick={() => setShowXpModal(false)} className="w-full bg-teal-500 text-white font-bold">Fermer</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
        ...
        <DialogContent className="sm:max-w-[400px] bg-zinc-950 border-zinc-800 rounded-3xl">
          ...
          <div className="flex flex-col items-center space-y-6 py-4">
            <div className="text-center">
              ...
              <p className="text-sm font-bold text-zinc-400 uppercase tracking-widest">Jours consécutifs</p>
            </div>
          ...
          <DialogFooter>
            <Button onClick={() => setShowStreakModal(false)} className="w-full bg-orange-500 text-white font-bold">Continuer l'effort</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </div>
