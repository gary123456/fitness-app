...
import { ArrowLeft, Loader2, Info, Star, PlayCircle, Dumbbell } from "lucide-react";
  ...
  return (
    <div className="flex flex-col min-h-screen bg-zinc-50 dark:bg-zinc-950">
      <div className="flex items-center px-4 py-4 border-b border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 sticky top-0 z-10">
        ...
        <div>
          <h1 className="text-xl font-black dark:text-zinc-50">{exercise ? exercise.name : (lang === 'FR' ? "Chargement..." : "Loading...")}</h1>
        ...
        {!exercise ? (
          ...
          <>
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-2xl p-6 border border-zinc-200 dark:border-zinc-800 shadow-md relative">
              ...
              <h4 className="flex items-center text-sm font-black uppercase tracking-widest text-zinc-900 dark:text-zinc-100 mb-4 border-b border-zinc-100 dark:border-zinc-800 pb-3 w-3/4">
